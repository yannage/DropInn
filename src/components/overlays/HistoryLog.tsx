      ...
      <div style={{
        ...
        <div style={{
          ...
          <span className="heading" style={{ fontSize: 13, letterSpacing: '0.12em', color: '#3A2414' }}>
            CHRONICLE — The Dragon of Ash Hollow
          </span>
          <button onClick={closeOverlay} style={{
            background: 'none', border: 'none', cursor: 'pointer',
            fontFamily: 'Cinzel, serif', fontSize: 14, color: '#5C3F09',
          }}>✕</button>
        </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px' }}>
          {storyLog.length === 0 ? (
            ...
            storyLog.map((entry, i) => <EntryRow key={i} entry={entry}/>)
          )}
        </div>
        ...
        <div style={{
          ...
          background: 'rgba(160,130,80,0.2)',
          fontFamily: 'EB Garamond, serif', fontStyle: 'italic', fontSize: 11, color: '#7a6a44',
        }}>
